...
class REVERSE_STR:
    ...
    def reverse_str(self,str_val:str)->str: # it tells programmer that it accept string valu and return to make it more readability
